...
const SDG = (props: IconProps) => {
  const { height, width, x, y } = props;
  return (<svg xmlns="http://www.w3.org/2000/svg" x={x} y={y} width={width ? width : 20} height={height ? height : 20} viewBox="0 0 19.413 19.406">

    <g id="Group_363" data-name="Group 363" transform="translate(-657.695 -113.414)">

      <path id="path1200-4" d="M722.479,137.078l-3.81,1.71a5.538,5.538,0,0,1,.44,1.552l4.14-.538A9.705,9.705,0,0,0,722.479,137.078Z" transform="translate(-46.222 -17.939)" fill="#c31f33" fill-rule="evenodd" />

      <path id="path1200-4-1" d="M716.815,124.966l-2.935,2.971a5.536,5.536,0,0,1,.97,1.288l3.666-2a9.705,9.705,0,0,0-1.7-2.261Z" transform="translate(-42.592 -8.757)" fill="#279b48" fill-rule="evenodd" />

      <path id="path1200-4-1-5" d="M708.584,116.708l-1.663,3.83a5.536,5.536,0,0,1,1.37.851l2.7-3.187a9.705,9.705,0,0,0-2.4-1.494Z" transform="translate(-37.316 -2.497)" fill="#d3a029" fill-rule="evenodd" />

      <path id="path1200-4-1-5-8" d="M698.9,113.42l-.167,4.172a5.537,5.537,0,0,1,1.585.3l1.364-3.946A9.706,9.706,0,0,0,698.9,113.42Z" transform="translate(-31.109 -0.004)" fill="#eb1c2d" fill-rule="evenodd" />

      <path id="path1200-4-1-5-8-0" d="M684.835,113.93l1.351,3.951a5.538,5.538,0,0,1,1.586-.294l-.154-4.172A9.706,9.706,0,0,0,684.835,113.93Z" transform="translate(-20.573)" fill="#183668" fill-rule="evenodd" />

      <path id="path1200-4-1-5-8-0-0" d="M672,118.141l2.687,3.2a5.538,5.538,0,0,1,1.372-.847l-1.651-3.835A9.706,9.706,0,0,0,672,118.141Z" transform="translate(-10.842 -2.457)" fill="#02558b" fill-rule="evenodd" />

      <path id="path1200-4-1-5-8-0-0-0" d="M662.648,127.129l3.66,2.01a5.537,5.537,0,0,1,.973-1.286l-2.924-2.98A9.708,9.708,0,0,0,662.648,127.129Z" transform="translate(-3.755 -8.686)" fill="#5dbb46" fill-rule="evenodd" />

      <path id="path1200-4-1-5-8-0-0-0-4" d="M658.048,139.678l4.139.552a5.536,5.536,0,0,1,.443-1.551l-3.8-1.722A9.706,9.706,0,0,0,658.048,139.678Z" transform="translate(-0.267 -17.847)" fill="#007dbc" fill-rule="evenodd" />

      <path id="path1200-4-1-5-8-0-0-0-4-7" d="M657.967,154.1l4.059-.981a5.537,5.537,0,0,1-.147-1.606l-4.169-.232A9.71,9.71,0,0,0,657.967,154.1Z" transform="translate(0 -28.702)" fill="#48773e" fill-rule="evenodd" />

      <path id="path1200-4-1-5-8-0-0-0-4-7-5" d="M660.914,164.392l3.431-2.381a5.537,5.537,0,0,1-.717-1.444l-3.971,1.29a9.706,9.706,0,0,0,1.257,2.536Z" transform="translate(-1.487 -35.745)" fill="#cf8d2a" fill-rule="evenodd" />

      <path id="path1200-4-1-5-8-0-0-0-4-7-5-3" d="M668.8,172.493l2.339-3.459a5.537,5.537,0,0,1-1.19-1.088l-3.237,2.637a9.707,9.707,0,0,0,2.089,1.91Z" transform="translate(-6.833 -41.338)" fill="#f99d26" fill-rule="evenodd" />

      <path id="path1200-4-1-5-8-0-0-0-4-7-5-3-1" d="M680.6,178.029l.931-4.071a5.538,5.538,0,0,1-1.5-.584L677.963,177A9.705,9.705,0,0,0,680.6,178.029Z" transform="translate(-15.364 -45.453)" fill="#e11484" fill-rule="evenodd" />

      <path id="path1200-4-1-5-8-0-0-0-4-7-5-3-1-4" d="M694.727,180.253l-.6-4.132a5.537,5.537,0,0,1-1.613,0l-.616,4.129a9.707,9.707,0,0,0,2.83,0Z" transform="translate(-25.927 -47.534)" fill="#f36d25" fill-rule="evenodd" />

      <path id="path1200-4-1-5-8-0-0-0-4-7-5-3-1-4-0" d="M706.4,177.046l-2.054-3.636a5.537,5.537,0,0,1-1.5.581l.918,4.073a9.707,9.707,0,0,0,2.641-1.018Z" transform="translate(-34.221 -45.481)" fill="#8f1838" fill-rule="evenodd" />

      <path id="path1200-4-1-5-8-0-0-0-4-7-5-3-1-4-0-1" d="M714.978,170.653l-3.229-2.648a5.539,5.539,0,0,1-1.193,1.085l2.327,3.467a9.705,9.705,0,0,0,2.095-1.9Z" transform="translate(-40.072 -41.383)" fill="rgba(253,183,19,0.99)" fill-rule="evenodd" />

      <path id="path1200-4-1-5-8-0-0-0-4-7-5-3-1-4-0-1-3" d="M721.241,161.945l-3.967-1.3a5.537,5.537,0,0,1-.721,1.443l3.422,2.392a9.7,9.7,0,0,0,1.266-2.531Z" transform="translate(-44.618 -35.802)" fill="#00aed9" fill-rule="evenodd" />

      <path id="path1200-4-1-5-8-0-0-0-4-7-5-3-1-4-0-1-3-0" d="M724.34,151.414l-4.17.218a5.538,5.538,0,0,1-.151,1.606l4.055.994a9.705,9.705,0,0,0,.266-2.818Z" transform="translate(-47.246 -28.807)" fill="#ef402b" fill-rule="evenodd" />
...
export { IDPsInCamps, NonDisplaced, IDPsReturnees, SDG, Nomade }
