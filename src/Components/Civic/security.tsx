...
export default function Security(props:JipsBarChartProps) {
  const { Title } = Typography;
  return (
    <div style={{ minHeight: "29vh", maxHeight: "30vh", padding: "10px" }}>
      <Typography>
        <Title style={{ fontSize: "14px" }}>Households that have experienced incidents the 12 months before the survey:</Title>
      </Typography>
      <BarChart
        width={400}
        height={300}
